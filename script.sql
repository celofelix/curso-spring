...
ALTER TABLE ONLY public.tb_products_category
    ADD CONSTRAINT tb_products_category_pkey PRIMARY KEY (product_id, category_id);
...
--
-- Name: tb_products_category fk42wc0160itocknpm47mnbpndr; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_products_category
    ADD CONSTRAINT fk42wc0160itocknpm47mnbpndr FOREIGN KEY (product_id) REFERENCES public.tb_product(id);
